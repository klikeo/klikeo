  ...
  return (
    <div className="mx-auto max-w-6xl px-6 py-10">
      <div className="mb-6 flex items-center justify-between gap-4">
        <div>
          <h1 className="text-3xl font-bold text-text">Testimonios</h1>
          <p className="mt-1 text-sm text-text-secondary">
            Administración de reseñas y testimonios de la plataforma.
          </p>
        </div>
      ...
      <div className="rounded-xl border border-border bg-card p-6 text-text-secondary">
        Esta sección aún no tiene lógica de administración implementada, pero la ruta ya está disponible
        y protegida para administradores.
      </div>
    </div>
  )
}
