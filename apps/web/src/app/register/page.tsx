...
export default function RegisterPage() {
  ...
  const inputBaseClass = "w-full px-3.5 py-2.5 border rounded-lg text-sm outline-none bg-surface text-text border-border focus:border-primary"
      ...
      <div className="max-w-md mx-auto mt-16 px-6">
        <div className="bg-surface rounded-xl p-10 border border-border">
          ...
          <p className="text-center mt-6 text-sm text-muted">
            ¿Ya tienes cuenta?{' '}
            <Link href="/login" className="text-primary no-underline font-medium hover:underline">
              Inicia sesión
            </Link>
          </p>
        </div>
